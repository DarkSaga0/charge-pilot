  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-to-br from-primary/5 via-background to-secondary/5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-[400px] h-[400px] rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-secondary/10 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Join 50,000+ EV drivers who have eliminated charging anxiety. 
            Download ChargePilot today and never worry about finding a charger again.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            Free to download. No credit card required. Start charging smarter today.
          </p>
        </motion.div>
      </div>
    </section>
